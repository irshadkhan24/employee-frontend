...
import {FaBuilding, FaTachometerAlt, FaUsers, FaCalendarAlt, FaCogs, FaRegCalendarAlt} from 'react-icons/fa'
  ...
  return (
    <div className="bg-gray-800 text-white h-screen fixed left-0 top-0 bottom-0 space-y-2 w-64">
        <div className='bg-[#0078D7] h-12 flex items-center justify-center'>
           { /* <h3 className='text-2x1 text-center font-pacific'>Employee Management System</h3> */}
        </div>
