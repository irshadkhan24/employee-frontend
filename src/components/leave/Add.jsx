        ...
        <form onSubmit={handleSubmit}>
            <div className="flex flex-col space-y-4">
                ...
                <div>
                    ...
                    className="w-full border border-gray-300 rounded-md"></textarea>
                </div>
            </div>
            <button type="Submit" className="w-full mt-6 bg-[#F59E0B] hover:bg-[#F6A723] text-white font-bold py-2 px-4 rounded-md">
                Add Leave
            </button>
        </form>
    </div>
