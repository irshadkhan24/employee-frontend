      ...
      try {
        ...
        if(response.data.success) {
          ...
          const data = response.data.employees.map((emp) => ({
            ...
            dob: new Date(emp.dob).toLocaleDateString(), // toDateString - show in latters
            profileImage: < img width={40} className='rounded-full' src={`http://localhost:5000/${emp.userId.profileImage}`} />,  // picture show on screen
